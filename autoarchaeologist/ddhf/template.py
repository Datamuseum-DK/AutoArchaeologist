...
LOGO = '<img src="https://datamuseum.dk/w/images/ddhf.png">'
WHO = '<a href="https://datamuseum.dk/">Datamuseum.dk</a>'
TOPIC= ""
TOPIC_LINK = '<A href="https://datamuseum.dk/wiki/Forside">DataMuseum.dk</A>'
...
class Excavation():
    ...
    def __init__(self):
        ...
        self.html_logo = LOGO
        self.html_who = WHO
        self.html_topic = TOPIC
        self.html_topic_link = TOPIC_LINK
    ...
    def produce_html(
        ...
        for this in self.hashes.values():
            ...
            if downloads:
                binfilename = self.html_dir + "/" + self.filename_for(this, suf=".bin")
                open(binfilename, 'wb').write(this)
...
<td style="style=vertical-align: top; padding-left: 40px; padding-right: 40px;">
<H1>''' + self.html_who + '''</H1>
<H2>''' + self.html_topic + '''</H2>
</td>
...
<br>
artifacts from
<A href="https://datamuseum.dk/">Datamuseum.dk</A>'s <A href="https://datamuseum.dk/wiki/Bits:Keyword">BitArchive</A>.
<p>
For more information about ''' + self.html_topic + ''' see ''' + self.html_topic_link + '''
<p>
Produced by: <A href="https://github.com/Datamuseum-DK/AutoArchaeologist">AutoArchaeologist</A> - Free &amp; Open Source Software.
</td>
</tr>
</table>
<hr/>
...
class ArtifactClass(bytes):
    ...
    def __new__(self, _up, _digest, bits):
