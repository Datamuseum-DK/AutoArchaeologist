'''
Christian Rovsing CR16 Artifacts from Datamuseum.dk's BitStore
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
class CR16_Ds2089(type_case.DS2089):
    ''' ... '''
...
class CR16TypeCase(type_case.Ascii):
...
class CR16(ddhf.DDHF_Excavation):
...
if __name__ == "__main__":
    ddhf.main(
        CR16,
        html_subdir="cr16",
        ddhf_topic = 'Christian Rovsing CR16 "Ambassador"',
        ddhf_topic_link = 'https://datamuseum.dk/wiki/CR16_Ambassador'
    )
